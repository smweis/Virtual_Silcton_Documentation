...
* **All lab members will prioritize a healthy and supportive lab culture.** 
  The SCANN lab is deeply committed to maintaining a harrassment-free and inclusive culture. All lab members are expected to treat each other with respect, professionalism, and general courtesy. We strive for diversity, anti-racism, and inclusivity. Some guiding principles are [here](https://coco-net.org/wp-content/uploads/2019/11/Coco-WhiteSupCulture-ENG4.pdf). We also follow [UF harrassment policy](https://hr.ufl.edu/forms-policies/policies-managers/sexual-harassment/). 
...
## PhD Students
  PhD students are expected 

## Lab Manager

## Undergraduate Research Assistants (PSY4911)
