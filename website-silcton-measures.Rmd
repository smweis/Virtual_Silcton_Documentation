...
All methods of encoding also record the Participant's facing direction and location every 10ms. These data can be found under the Navigation Log section of View Data. 
...
### Distance Estimation Task (Not recommended)
